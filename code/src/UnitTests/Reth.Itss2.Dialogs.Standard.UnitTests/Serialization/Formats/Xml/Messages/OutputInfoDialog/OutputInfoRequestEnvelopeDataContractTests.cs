...
{
    [TestClass]
    public class OutputInfoRequestEnvelopeDataContractTests:XmlMessageTests
    {
        public static ( String Xml, IMessageEnvelope Object ) Request
        {
            get
            {
                ...
                return (    $@" <WWKS Version=""2.0"" TimeStamp=""{ XmlMessageTests.Timestamp }"">
                                    <OutputInfoRequest  Id=""{ XmlMessageTests.MessageId }""
                            ...
                            new MessageEnvelope(    new OutputInfoRequest(  XmlMessageTests.MessageId,
