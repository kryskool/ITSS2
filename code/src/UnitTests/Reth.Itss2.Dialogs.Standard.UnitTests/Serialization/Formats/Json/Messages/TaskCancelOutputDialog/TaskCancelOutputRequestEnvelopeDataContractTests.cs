...
{
    [TestClass]
    public class TaskCancelOutputRequestEnvelopeDataContractTests:JsonMessageTests
    {
        public static ( String Xml, IMessageEnvelope Object ) Request
        {
            get
            {
                ...
                return (    $@" {{
                            ...
                            new MessageEnvelope(    new TaskCancelOutputRequest(    JsonMessageTests.MessageId,
