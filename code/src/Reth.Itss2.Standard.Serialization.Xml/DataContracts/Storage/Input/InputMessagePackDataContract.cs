...
{
    internal class InputMessagePackDataContract<TTypeMappings>:XmlSerializable<InputMessagePack, TTypeMappings>
        where TTypeMappings:ITypeMappings
    {
        ...
        public override void ReadXml( XmlReader reader )
        {
            ...
            this.DataObject = new InputMessagePack( scanCode,
                                                    deliveryNumber,
                                                    batchNumber,
                                                    externalId,
                                                    serialNumber,
        ...
        {
            InputMessagePack dataObject = this.DataObject;
