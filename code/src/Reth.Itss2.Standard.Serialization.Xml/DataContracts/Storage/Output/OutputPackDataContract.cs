...
{
    internal class OutputPackDataContract<TTypeMappings>:XmlSerializable<OutputPack, TTypeMappings>
        where TTypeMappings:ITypeMappings
    {
        ...
        public override void ReadXml( XmlReader reader )
        {
            ...
            this.DataObject = new OutputPack(   id,
                                                outputDestination,
                                                outputPoint,
                                                deliveryNumber,
                                                batchNumber,
        ...
        {
            OutputPack dataObject = this.DataObject;
