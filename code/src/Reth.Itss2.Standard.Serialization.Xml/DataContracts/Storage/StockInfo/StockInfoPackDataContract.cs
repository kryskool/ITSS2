...
{
    internal class StockInfoPackDataContract<TTypeMappings>:XmlSerializable<StockInfoPack, TTypeMappings>
        where TTypeMappings:ITypeMappings
    {
        ...
        public override void ReadXml( XmlReader reader )
        {
            ...
            Nullable<PackState> state = base.Serializer.ReadOptionalEnum<PackState>( reader, nameof( this.DataObject.State ), PackState.Available );
            Nullable<bool> isInFridge = base.Serializer.ReadOptionalBool( reader, nameof( this.DataObject.IsInFridge ), false );

            this.DataObject = new StockInfoPack(    id,
                                                    deliveryNumber,
                                                    batchNumber,
                                                    externalId,
                                                    serialNumber,
        ...
        {
            StockInfoPack dataObject = this.DataObject;
