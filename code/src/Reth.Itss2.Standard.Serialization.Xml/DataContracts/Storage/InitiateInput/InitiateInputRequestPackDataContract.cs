...
{
    internal class InitiateInputRequestPackDataContract<TTypeMappings>:XmlSerializable<InitiateInputRequestPack, TTypeMappings>
        where TTypeMappings:ITypeMappings
    {
        ...
        public override void ReadXml( XmlReader reader )
        {
            ...
            this.DataObject = new InitiateInputRequestPack( scanCode,
                                                            deliveryNumber,
                                                            batchNumber,
                                                            externalId,
                                                            serialNumber,
        ...
        {
            InitiateInputRequestPack dataObject = this.DataObject;
