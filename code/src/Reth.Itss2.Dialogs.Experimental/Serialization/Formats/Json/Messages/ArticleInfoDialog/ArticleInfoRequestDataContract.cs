...
using ArticleInfoRequestArticleDataContract = Reth.Itss2.Dialogs.Standard.Serialization.Formats.Json.Messages.ArticleInfo.ArticleInfoRequestArticleDataContract;
