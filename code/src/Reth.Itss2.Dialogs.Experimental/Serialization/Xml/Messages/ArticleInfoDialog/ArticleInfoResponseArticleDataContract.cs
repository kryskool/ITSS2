...
namespace Reth.Itss2.Dialogs.Experimental.Serialization.Xml.Messages.ArticleInfoDialog
{
    public class ArticleInfoResponseArticleDataContract:IDataContract<ArticleInfoResponseArticle>
    {
        ...
        [XmlAttribute]
        public String? RequiresFridge
        {
            get; set;
        }

        [XmlAttribute]
        public String? MaxSubItemQuantity
        {
            get; set;
        }

        [XmlAttribute]
        public String? SerialNumberSinceExpiryDate
        {
            get; set;
        }

        [XmlElement( ElementName = "Tag" )]
        public ArticleTagDataContract[]? ArticleTags
        {
            get; set;
        }

        [XmlElement( ElementName = "Article" )]
        public CrossSellingArticleDataContract[]? CrossSellingArticles
        {
            get; set;
        }

        [XmlElement( ElementName = "Article" )]
        public AlternativeArticleDataContract[]? AlternativeArticles
        {
            get; set;
        }

        [XmlElement( ElementName = "Article" )]
        public AlternativePackSizeArticleDataContract[]? AlternativePackSizeArticles
        {
            get; set;
        }
