...
using ArticleInfoRequestArticleDataContract = Reth.Itss2.Dialogs.Standard.Serialization.Xml.Messages.ArticleInfoDialog.ArticleInfoRequestArticleDataContract;
...
namespace Reth.Itss2.Dialogs.Experimental.Serialization.Xml.Messages.ArticleInfoDialog
{
    public class ArticleInfoRequestDataContract:SubscribedRequestDataContract<ArticleInfoRequest>
    {
        ...
        [XmlAttribute]
        public String? IncludeCrossSellingArticles
        {
            get; set;
        }

        [XmlAttribute]
        public String? IncludeAlternativeArticles
        {
            get; set;
        }

        [XmlAttribute]
        public String? IncludeAlternativePackSizeArticles
        {
            get; set;
        }
