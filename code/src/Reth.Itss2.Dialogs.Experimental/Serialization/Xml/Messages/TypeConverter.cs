...
using Reth.Itss2.Dialogs.Experimental.Serialization.Xml.Messages.ArticleInfoDialog;
using Reth.Itss2.Dialogs.Experimental.Serialization.Xml.Messages.ArticlePriceDialog;
using Reth.Itss2.Dialogs.Experimental.Serialization.Xml.Messages.ShoppingCartUpdateDialog;

namespace Reth.Itss2.Dialogs.Experimental.Serialization.Xml.Messages
{
    public class TypeConverter:Standard.Serialization.Xml.Messages.TypeConverter
    {
