...
{
    public class ArticleInfoResponseArticle:Standard.Protocol.Messages.ArticleInfoDialog.ArticleInfoResponseArticle, IEquatable<ArticleInfoResponseArticle>
    {
		...
		{
            bool result = Standard.Protocol.Messages.ArticleInfoDialog.ArticleInfoResponseArticle.Equals( left, right );
