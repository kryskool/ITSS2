...
{
    public class ArticleInfoResponse:Standard.Protocol.Messages.ArticleInfoDialog.ArticleInfoResponse, IEquatable<ArticleInfoResponse>
    {
		...
		{
            return Standard.Protocol.Messages.ArticleInfoDialog.ArticleInfoResponse.Equals( left, right );
		}
