...
{
    public class ArticleInfoRequest:Standard.Protocol.Messages.ArticleInfo.ArticleInfoRequest, IEquatable<ArticleInfoRequest>
    {
		...
		{
            bool result = Standard.Protocol.Messages.ArticleInfo.ArticleInfoRequest.Equals( left, right );
