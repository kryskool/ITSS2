...
{
    public class SalesSupportSystemShoppingCartUpdateDialog:Dialog, ISalesSupportSystemShoppingCartUpdateDialog
    {
        public event EventHandler<MessageReceivedEventArgs>? RequestReceived;

        public SalesSupportSystemShoppingCartUpdateDialog( IDialogProvider dialogProvider )
        :
