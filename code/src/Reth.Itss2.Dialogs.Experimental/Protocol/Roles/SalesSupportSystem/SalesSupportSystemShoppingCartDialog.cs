...
{
    public class SalesSupportSystemShoppingCartDialog:Dialog, ISalesSupportSystemShoppingCartDialog
    {
        ...
        {
            return base.SendRequestAsync<ShoppingCartRequest, ShoppingCartResponse>( request );
        }
