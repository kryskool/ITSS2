...
namespace Reth.Itss2.StandardExtensions.Dialogs
{
    ...
    {
        public static readonly DialogName ConfigurationGet = new DialogName( "ConfigurationGet" );
        
        static DialogName()
        {
            DialogName.AddAvailableName( DialogName.ConfigurationGet.Value, DialogName.ConfigurationGet );
        }
