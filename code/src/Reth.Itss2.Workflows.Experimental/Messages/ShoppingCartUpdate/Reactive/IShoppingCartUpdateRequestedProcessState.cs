...
{
    public interface IShoppingCartUpdateRequestedProcessState:IProcessState
    {
        ShoppingCartUpdateRequest Request{ get; }

        void Finish(    ShoppingCartContent shoppingCart,
                        ShoppingCartUpdateResult result );

        Task FinishAsync(   ShoppingCartContent shoppingCart,
                            ShoppingCartUpdateResult result,
