...
{
    internal class ShoppingCartUpdateRequestedProcessState:ProcessState, IShoppingCartUpdateRequestedProcessState
    {
        ...
        private ShoppingCartUpdateWorkflow Workflow
        {
            get;
        }

        public ShoppingCartUpdateRequest Request
        {
            get;
        }
