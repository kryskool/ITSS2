...
{
    public class ArticleMasterSetArticle:Standard.Protocol.Messages.ArticleMasterSet.ArticleMasterSetArticle, IEquatable<ArticleMasterSetArticle>
    {
		...
		{
            bool result = Standard.Protocol.Messages.ArticleMasterSet.ArticleMasterSetArticle.Equals( left, right );
