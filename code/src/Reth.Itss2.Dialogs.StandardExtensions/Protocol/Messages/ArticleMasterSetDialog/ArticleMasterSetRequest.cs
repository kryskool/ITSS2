...
{
    public class ArticleMasterSetRequest:Standard.Protocol.Messages.ArticleMasterSetDialog.ArticleMasterSetRequest, IEquatable<ArticleMasterSetRequest>
    {
		...
		{
            return Standard.Protocol.Messages.ArticleMasterSetDialog.ArticleMasterSetRequest.Equals( left, right );
		}
