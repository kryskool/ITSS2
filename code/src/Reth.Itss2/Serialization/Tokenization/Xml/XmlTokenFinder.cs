...
namespace Reth.Itss2.Serialization.Tokenization.Xml
{
    internal class XmlTokenFinder:TokenFinder<XmlTokenState>
    {
        ...
        protected internal override ITokenPatternMatch? FindNextMatch(  XmlTokenState currentState,
        ...
        protected internal override ITokenTransition<XmlTokenState>? CreateTransition(  IEnumerable<ITokenTransition<XmlTokenState>> transitions,
                                                                                        ITokenPatternMatch nextMatch    )
        {
            ...
            {
                throw Assert.Exception( new ArgumentException( $"Unknown token pattern in match '{ nextMatch.Pattern }'.", nameof( nextMatch ) ) );
            }
