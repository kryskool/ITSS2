...
namespace Reth.Itss2.Serialization.Tokenization.Json
{
    internal class JsonTokenFinder:TokenFinder<JsonTokenState>
    {
        ...
        protected internal override ITokenPatternMatch? FindNextMatch(  JsonTokenState currentState,
        ...
        protected internal override ITokenTransition<JsonTokenState>? CreateTransition( IEnumerable<ITokenTransition<JsonTokenState>> transitions,
