...
namespace Reth.Itss2.Workflows.StandardExtensions.Messages.ConfigurationGet.Active
{
    ...
    {
        IConfigurationGetFinishedProcessState StartProcess();
                
        Task<IConfigurationGetFinishedProcessState> StartProcessAsync( CancellationToken cancellationToken = default );
    }
}
