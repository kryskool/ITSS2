...
{
    public class ConfigurationGetFinishedProcessState:ProcessState, IConfigurationGetFinishedProcessState
    {
        public ConfigurationGetFinishedProcessState(    ConfigurationGetRequest request,
        ...
        public ConfigurationGetResponse Response
        {
            get;
        }
    }
