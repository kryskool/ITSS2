...
namespace Reth.Itss2.Dialogs.Standard.Protocol.Messages.StockDeliveryInfo.Reactive
{
    ...
    {
        public event EventHandler<MessageReceivedEventArgs<StockDeliveryInfoRequest>>? RequestReceived;
        ...
        public override void Connect( IMessageTransmitter messageTransmitter )
        {
            base.Connect(   messageTransmitter,
                            ( IMessage message ) =>
                            {
                                this.Dispatch<StockDeliveryInfoRequest>( message, this.OnRequestReceived );
                            }   );
        }
