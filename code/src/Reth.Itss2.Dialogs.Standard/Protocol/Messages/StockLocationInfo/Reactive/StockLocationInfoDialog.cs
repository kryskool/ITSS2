...
{
    public class StockLocationInfoDialog:Dialog, IStockLocationInfoDialog
    {
        public event EventHandler<MessageReceivedEventArgs<StockLocationInfoRequest>>? RequestReceived;
        ...
        public override void Connect( IMessageTransmitter messageTransmitter )
        {
            base.Connect(   messageTransmitter,
                            ( IMessage message ) =>
                            {
                                this.Dispatch<StockLocationInfoRequest>( message, this.OnRequestReceived );
                            }   );
        }
