...
namespace Reth.Itss2.Dialogs.Standard.Protocol.Messages.InitiateInput.Active
{
    public class InitiateInputDialog:Dialog, IInitiateInputDialog
    {
        public event EventHandler<MessageReceivedEventArgs<InitiateInputMessage>>? MessageReceived;
