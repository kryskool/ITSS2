...
{
    public class StockDeliveryInfoPack:IEquatable<StockDeliveryInfoPack>
    {
        public static bool operator==( StockDeliveryInfoPack? left, StockDeliveryInfoPack? right )
		{
            return StockDeliveryInfoPack.Equals( left, right );
		}
        ...
        public static bool Equals( StockDeliveryInfoPack? left, StockDeliveryInfoPack? right )
		{
		...
		{
			return this.Equals( obj as StockDeliveryInfoPack );
		}
		
		public bool Equals( StockDeliveryInfoPack? other )
		{
            return StockDeliveryInfoPack.Equals( this, other );
		}
