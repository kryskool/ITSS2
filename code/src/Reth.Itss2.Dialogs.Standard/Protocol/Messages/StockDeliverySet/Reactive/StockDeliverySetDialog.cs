...
namespace Reth.Itss2.Dialogs.Standard.Protocol.Messages.StockDeliverySet.Reactive
{
    public class StockDeliverySetDialog:Dialog, IStockDeliverySetDialog
    {
        public event EventHandler<MessageReceivedEventArgs<StockDeliverySetRequest>>? RequestReceived;
        ...
        {
            this.RequestReceived?.Invoke( this, new MessageReceivedEventArgs<StockDeliverySetRequest>( request, this.DialogProvider ) );
        }
