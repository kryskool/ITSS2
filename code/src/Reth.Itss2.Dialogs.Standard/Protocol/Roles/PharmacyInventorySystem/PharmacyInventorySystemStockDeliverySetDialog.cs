...
{
    public class PharmacyInventorySystemStockDeliverySetDialog:Dialog, IPharmacyInventorySystemStockDeliverySetDialog
    {
        public PharmacyInventorySystemStockDeliverySetDialog( IDialogProvider dialogProvider )
        :
            base( "StockDelivery", dialogProvider )
        {
        }
        ...
        {
            return base.SendRequestAsync<StockDeliverySetRequest, StockDeliverySetResponse>( request );
        }
