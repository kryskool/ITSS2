...
{
    public class PharmacyInventorySystemStockDeliveryInfoDialog:Dialog, IPharmacyInventorySystemStockDeliveryInfoDialog
    {
        public PharmacyInventorySystemStockDeliveryInfoDialog( IDialogProvider dialogProvider )
        :
            base( Dialogs.StockDeliveryInfo, dialogProvider )
        {
        }
        ...
        {
            return base.SendRequestAsync<StockDeliveryInfoRequest, StockDeliveryInfoResponse>( request );
        }
