...
{
    public class PharmacyInventorySystemStatusDialog:Dialog, IPharmacyInventorySystemStatusDialog
    {
        public PharmacyInventorySystemStatusDialog( IDialogProvider dialogProvider )
        :
        ...
        {
            return base.SendRequestAsync<StatusRequest, StatusResponse>( request );
        }
