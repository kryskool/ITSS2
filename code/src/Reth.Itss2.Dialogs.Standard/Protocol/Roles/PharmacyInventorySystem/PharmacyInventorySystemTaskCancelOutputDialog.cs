...
{
    public class PharmacyInventorySystemTaskCancelOutputDialog:Dialog, IPharmacyInventorySystemTaskCancelOutputDialog
    {
        public PharmacyInventorySystemTaskCancelOutputDialog( IDialogProvider dialogProvider )
        :
