...
{
    public class PharmacyInventorySystemStockLocationInfoDialog:Dialog, IPharmacyInventorySystemStockLocationInfoDialog
    {
        ...
        {
            return base.SendRequestAsync<StockLocationInfoRequest, StockLocationInfoResponse>( request );
        }
