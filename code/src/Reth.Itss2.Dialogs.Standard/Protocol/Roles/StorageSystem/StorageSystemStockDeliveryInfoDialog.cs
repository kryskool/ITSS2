...
{
    public class StorageSystemStockDeliveryInfoDialog:Dialog, IStorageSystemStockDeliveryInfoDialog
    {
        public event EventHandler<MessageReceivedEventArgs>? RequestReceived;

        public StorageSystemStockDeliveryInfoDialog( IDialogProvider dialogProvider )
        :
