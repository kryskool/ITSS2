...
{
    public class StorageSystemOutputInfoDialog:Dialog, IStorageSystemOutputInfoDialog
    {
        public event EventHandler<MessageReceivedEventArgs>? RequestReceived;

        public StorageSystemOutputInfoDialog( IDialogProvider dialogProvider )
        :
            base( Dialogs.OutputInfo, dialogProvider )
        {
        }
