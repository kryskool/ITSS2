...
{
    internal class WithinStringTokenState:JsonTokenState
    {
        public WithinStringTokenState()
        {
        }
                                                                    ...
                                                                    ref long position   )
        {
            ...
            ITokenPatternMatch? match = JsonTokenPatterns.EndOfString.GetFirstMatch( ref buffer, position, JsonSerializationSettings.Escape );
