...
{
    internal class JsonTokenStateTransition:TokenStateTransition
    {
        public JsonTokenStateTransition(    ITokenState from,
                                            ITokenState to,
        ...
        public override bool IsMessageBegin()
        {
            return  this.From.GetType().Equals( typeof( OutOfMessageTokenState ) ) &&
                    this.To.GetType().Equals( typeof( WithinObjectTokenState ) );
        }

        public override bool IsMessageEnd()
        {
            return  this.From.GetType().Equals( typeof( WithinObjectTokenState ) ) &&
