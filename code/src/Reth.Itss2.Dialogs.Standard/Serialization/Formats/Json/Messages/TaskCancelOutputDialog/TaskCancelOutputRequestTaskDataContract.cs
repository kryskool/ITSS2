...
{
    public class TaskCancelOutputRequestTaskDataContract:IDataContract<TaskCancelOutputRequestTask>
    {
        ...
        public TaskCancelOutputRequestTask GetDataObject()
        {
            return new TaskCancelOutputRequestTask( TypeConverter.MessageId.ConvertTo( this.Id ) );
        }
    }
}
