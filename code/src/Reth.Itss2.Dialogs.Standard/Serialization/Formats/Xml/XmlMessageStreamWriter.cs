...
{
    public class XmlMessageStreamWriter:MessageStreamWriter
    {
        public XmlMessageStreamWriter( Stream baseStream )
        :
            this( baseStream, NullInteractionLog.Instance )
        {
        }

        public XmlMessageStreamWriter( Stream baseStream, IInteractionLog interactionLog )
        :
        ...
        public XmlMessageStreamWriter( Stream baseStream, ISerializationProvider serializationProvider )
        :
