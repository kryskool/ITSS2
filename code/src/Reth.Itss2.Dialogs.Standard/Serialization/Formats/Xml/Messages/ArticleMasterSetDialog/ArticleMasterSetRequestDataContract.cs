...
namespace Reth.Itss2.Dialogs.Standard.Serialization.Formats.Xml.Messages.ArticleMasterSet
{
    public class ArticleMasterSetRequestDataContract:SubscribedRequestDataContract<ArticleMasterSetRequest>
    {
        ...
        :
            base( dataObject )
        {
            this.Articles = TypeConverter.ConvertFromDataObjects<ArticleMasterSetArticle, ArticleMasterSetArticleDataContract>( dataObject.GetArticles() );
        }

        [XmlElement( ElementName = "Article" )]
        public ArticleMasterSetArticleDataContract[]? Articles{ get; set; }
