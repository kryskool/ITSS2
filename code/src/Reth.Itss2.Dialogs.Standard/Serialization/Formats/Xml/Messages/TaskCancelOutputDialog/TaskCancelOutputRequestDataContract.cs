...
{
    public class TaskCancelOutputRequestDataContract:SubscribedRequestDataContract<TaskCancelOutputRequest>
    {
        public TaskCancelOutputRequestDataContract()
        {
            this.Task = new TaskCancelOutputRequestTaskDataContract();
        }
        ...
        {
            return new TaskCancelOutputRequest( TypeConverter.MessageId.ConvertTo( this.Id ),
                                                TypeConverter.SubscriberId.ConvertTo( this.Source ),
                                                TypeConverter.SubscriberId.ConvertTo( this.Destination ),
                                                TypeConverter.ConvertToDataObject<TaskCancelOutputRequestTask, TaskCancelOutputRequestTaskDataContract>( this.Task )    );
        }

        public override Type GetEnvelopeType()
        {
            return typeof( TaskCancelOutputRequestEnvelopeDataContract );
        }
    }
}
