...
{
    internal class WithinMessageTokenState:XmlTokenState
    {
        public WithinMessageTokenState()
        {
        }
                                                                    ...
                                                                    ref long position   )
        {
            ...
            ITokenPatternMatch? firstMatch = TokenPatternMatch.GetFirstMatch( new ITokenPattern[]{  XmlTokenPatterns.BeginOfMessage,
                                                                                                    XmlTokenPatterns.BeginOfData,
                                                                                                    XmlTokenPatterns.EndOfMessage   },
                                                                              ref buffer,
                                                                              ref position  );
