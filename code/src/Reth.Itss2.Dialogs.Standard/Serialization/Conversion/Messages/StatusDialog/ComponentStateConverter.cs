...
namespace Reth.Itss2.Dialogs.Standard.Serialization.Conversion.Messages.Status
{
    public class ComponentStateConverter
    {
        ...
        public ComponentState ConvertTo( String value )
        {
            return value.ConvertTo<ComponentState>();
        }

        public ComponentState? ConvertNullableTo( String? value )
        {
            return value.ConvertNullableTo<ComponentState>();
        }
    }
}
