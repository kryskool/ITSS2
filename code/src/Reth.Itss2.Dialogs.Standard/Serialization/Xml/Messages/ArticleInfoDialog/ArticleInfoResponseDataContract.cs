...
namespace Reth.Itss2.Dialogs.Standard.Serialization.Xml.Messages.ArticleInfoDialog
{
    public class ArticleInfoResponseDataContract:SubscribedResponseDataContract<ArticleInfoResponse>
    {
        ...
        :
            base( dataObject )
        {
            this.Articles = TypeConverter.ConvertFromDataObjects<ArticleInfoResponseArticle, ArticleInfoResponseArticleDataContract>( dataObject.GetArticles() );
        }
