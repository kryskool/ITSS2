...
using Reth.Itss2.Dialogs.Standard.Serialization.Xml.Messages.ArticleMasterSetDialog;
using Reth.Itss2.Dialogs.Standard.Serialization.Xml.Messages.InitiateInputDialog;
using Reth.Itss2.Dialogs.Standard.Serialization.Xml.Messages.InputDialog;
using Reth.Itss2.Dialogs.Standard.Serialization.Xml.Messages.StatusDialog;
using Reth.Itss2.Dialogs.Standard.Serialization.Xml.Messages.StockDeliveryInfoDialog;
using Reth.Itss2.Dialogs.Standard.Serialization.Xml.Messages.StockDeliverySetDialog;
using Reth.Itss2.Dialogs.Standard.Serialization.Xml.Messages.OutputDialog;
using Reth.Itss2.Dialogs.Standard.Serialization.Xml.Messages.OutputInfoDialog;
using Reth.Itss2.Dialogs.Standard.Serialization.Xml.Messages.TaskCancelOutputDialog;
...
namespace Reth.Itss2.Dialogs.Standard.Serialization.Xml.Messages
{
    public class TypeConverter
    {
        ...
        public static Int32 Int32{ get; } = new Int32();
