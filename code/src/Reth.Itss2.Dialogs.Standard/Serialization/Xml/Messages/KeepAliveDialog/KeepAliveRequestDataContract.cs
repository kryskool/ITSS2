...
namespace Reth.Itss2.Dialogs.Standard.Serialization.Xml.Messages.KeepAliveDialog
{
    public class KeepAliveRequestDataContract:SubscribedRequestDataContract<KeepAliveRequest>
    {
        ...
        public override KeepAliveRequest GetDataObject()
        {
            return new KeepAliveRequest(    TypeConverter.MessageId.ConvertTo( this.Id ),
        ...
        {
            return typeof( KeepAliveRequestEnvelopeDataContract );
        }
    }
}
