...
{
    public interface ITaskCancelOutputProcess:IProcess
    {
        TaskCancelOutputRequest Request{ get; }

        void SendResponse( TaskCancelOutputResponseTask task );
        Task SendResponseAsync( TaskCancelOutputResponseTask task );
    }
}
