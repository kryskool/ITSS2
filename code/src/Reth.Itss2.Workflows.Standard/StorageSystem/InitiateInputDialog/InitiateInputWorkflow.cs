...
{
    internal class InitiateInputWorkflow:Workflow, IInitiateInputWorkflow
    {
        public event EventHandler<ProcessStartEventArgs<IInitiateInputProcess>>? ProcessStarted;

        public InitiateInputWorkflow( IStorageSystemWorkflowProvider workflowProvider )
        :
        ...
        private IStorageSystemInitiateInputDialog Dialog
        {
            get{ return this.DialogProvider.InitiateInputDialog; }
        }
        ...
        private void Dialog_RequestReceived( Object sender, MessageReceivedEventArgs e )
        {
            ...
            this.OnRequestReceived( request,
                                    () =>
                                    {
                                        IInitiateInputProcess process = new InitiateInputProcess( this, request );

                                        this.ProcessStarted?.Invoke( this, new ProcessStartEventArgs<IInitiateInputProcess>( process ) );
                                    }   );
        }
    }
}
