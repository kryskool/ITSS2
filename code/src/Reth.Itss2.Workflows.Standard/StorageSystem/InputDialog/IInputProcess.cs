...
{
    public interface IInputProcess:IProcess
    {
        InputRequest Request{ get; }
        InputResponse Response{ get; }

        void SendMessage( IEnumerable<InputMessageArticle> articles );

        Task SendMessageAsync( IEnumerable<InputMessageArticle> articles );
    }
}
