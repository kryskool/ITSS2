...
namespace Reth.Itss2.Workflows.Standard.StorageSystem.KeepAliveDialog
{
    internal class KeepAliveTrigger:IDisposable
    {
        ...
        public KeepAliveTrigger( KeepAliveWorkflow workflow )
        :
            this( workflow, KeepAliveTrigger.DefaultInterval )
        {
        }

        public KeepAliveTrigger( KeepAliveWorkflow workflow, TimeSpan interval )
        {
        ...
        private KeepAliveWorkflow Workflow
        {
            get;
        }
