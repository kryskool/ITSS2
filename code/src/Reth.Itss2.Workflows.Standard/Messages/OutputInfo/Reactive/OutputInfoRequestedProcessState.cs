...
{
    public class OutputInfoRequestedProcessState:ProcessState, IOutputInfoRequestedProcessState
    {
        ...
        public void Finish( OutputInfoResponseTask task )
        {
            this.OnStateChange();
        ...
        public Task FinishAsync( OutputInfoResponseTask task, CancellationToken cancellationToken = default )
        {
            this.OnStateChange();

            return this.Workflow.SendResponseAsync( new OutputInfoResponse( this.Request, task ), cancellationToken );
        }
    }
}
